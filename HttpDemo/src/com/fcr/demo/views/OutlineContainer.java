...
public class OutlineContainer extends FrameLayout implements Animatable {
	...
	private void init() {
		...
		mOutlinePaint.setStrokeWidth(ViewPagerHelper.dpToPx(getResources(), 2));
		mOutlinePaint.setColor(getResources().getColor(R.color.button_color_left_hilo));
		mOutlinePaint.setStyle(Style.STROKE);

		int padding = ViewPagerHelper.dpToPx(getResources(), 10);
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		int offset = ViewPagerHelper.dpToPx(getResources(), 5);
